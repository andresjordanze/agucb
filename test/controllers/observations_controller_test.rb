...
class ObservationsControllerTest < ActionController::TestCase
  ...
  test "should create observation" do
    assert_difference('Observation.count') do
      post :create, observation: { detail: @observation.detail, match_id: @observation.match_id, referee: @observation.referee, team_id: @observation.team_id }
    end
  ...
  test "should update observation" do
    patch :update, id: @observation, observation: { detail: @observation.detail, match_id: @observation.match_id, referee: @observation.referee, team_id: @observation.team_id }
    assert_redirected_to observation_path(assigns(:observation))
  end
